...
def test_main(num_sms: int, local_rank: int, num_local_ranks: int, num_ranks: int, num_nodes: int, rank: int, buffer: deep_ep.Buffer, group: dist.ProcessGroup):
    ...
    if local_rank == 0:
        print("ref_num_tokens_per_rank: ", ref_num_tokens_per_rank.shape, ref_num_tokens_per_rank)
        print("ref_num_tokens_per_rdma_rank: ", ref_num_tokens_per_rdma_rank.shape, ref_num_tokens_per_rdma_rank)
        print("ref_num_tokens_per_expert: ", ref_num_tokens_per_expert.shape, ref_num_tokens_per_expert)
        print("ref_is_token_in_rank: ", ref_is_token_in_rank.shape, ref_is_token_in_rank)
